...
public class MainActivity extends com.google.mediapipe.apps.basic.MainActivity {
  ...
  private static final String KEYPOINTS_CLASSIFIER_PATH = "gesture_model_path";
  // Max number of hands to detect/process.
  private static final int NUM_HANDS = 2;
  private static final String KEYPOINT_CLASSIFIER = "mediapipe/modules/hand_gesture/keypoint_classifier.tflite";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    inputSidePackets.put(KEYPOINTS_CLASSIFIER_PATH, packetCreator.createString(KEYPOINT_CLASSIFIER));
